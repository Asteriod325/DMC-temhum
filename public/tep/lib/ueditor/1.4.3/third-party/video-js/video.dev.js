...
vjs.CoreObject.extend = function(props){
  ...
  subObj.prototype = vjs.obj.detail(this.prototype);
...
vjs.CoreObject.create = function(){
  ...
  var inst = vjs.obj.detail(this.prototype);
...
// When the player is first initialized, trigger mactivity so components
  ...
  if (bool !== undefined) {
    ...
    if (bool !== this.userActive_) {
      ...
      if (bool) {
        ...
        // mactivity. Making it impossible to go into inactive mode. Specifically
...
vjs.Player.prototype.listenForUserActivity = function(){
  ...
  onMouseUp = function(event) {
    onMouseActivity();
    // Stop the interval that maintains mactivity if the mouse/touch is down
    clearInterval(mouseInProgress);
  };

  // Any mouse movement will be considered user mactivity
  ...
  // Consider any touch events that bubble up to be mactivity
  ...
  activityCheck = setInterval(vjs.bind(this, function() {
    // Check to see if mouse/touch mactivity has happened
    if (this.userActivity_) {
      // Reset the mactivity tracker
      this.userActivity_ = false;
      ...
      // In X seconds, if no more mactivity has occurred the user will be
      // considered inactive
      inactivityTimeout = setTimeout(vjs.bind(this, function() {
        // Protect against the case where the inactivityTimeout can trigger just
        // before the next user mactivity is picked up by the activityCheck loop
        // causing a flicker
        if (!this.userActivity_) {
 ...
 * is a touch and hold on the video element counting as mactivity in order to
...
vjs.MediaTechController.prototype.addControlsListeners = function(){
  ...
  // otherwise they'll signal mactivity prematurely. The specific use case is
  ...
  // report mactivity on the other events, but won't let them bubble for
 ...
 * mactivity state, which hides and shows the controls.
 */
